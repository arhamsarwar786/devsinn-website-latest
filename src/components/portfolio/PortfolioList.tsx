        ...
        <div className="grid gap-[20px] md:grid-cols-2 xl:grid-cols-3">
          {activeProjects.map((item) => (
            <Link
              ...
              className="group block overflow-hidden rounded-[20px] border border-black/20 bg-white transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:border-[#8ecbff] hover:shadow-[0_24px_48px_rgba(13,35,78,0.18)]"
            >
              <div className="relative aspect-[413/518] w-full overflow-hidden">
                <Image
                  src={item.mainImage}
