...
export default function CoreTechnology() {
  ...
  return (
    <section className="bg-white px-5 pb-14 pt-6 text-[#172D56] sm:px-8 sm:pb-16 sm:pt-8 lg:px-10 lg:pb-20 lg:pt-10 xl:px-16 overflow-hidden">
      <motion.div 
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, margin: "-100px" }}
        variants={staggerContainer}
        className="mx-auto flex w-full max-w-[1280px] flex-col items-center gap-8 lg:gap-[32px]"
      >
        <div className="flex w-full max-w-[949px] flex-col items-center gap-6 text-center lg:gap-[24px]">
          <motion.h2 
            variants={fadeInUp}
            className="text-[30px] font-bold leading-[1.1475] tracking-[-0.02em] text-[#172D56] sm:text-[34px] lg:text-[40px] lg:leading-[45.9px]"
          >
          ...
          <motion.p 
            variants={fadeInUp}
            className="max-w-[867px] text-[16px] font-normal leading-[24px] tracking-[0] text-[#252525]"
          >
          ...
          <motion.div 
            variants={staggerContainer}
            className="flex w-full flex-col items-center justify-center gap-4 pt-2 sm:gap-5 lg:flex-row lg:gap-0"
          >
            {tabs.map((tab) => (
              <motion.button
                key={tab.label}
        ...
        <motion.div 
          variants={card3D}
          whileHover="hover"
          className="relative w-full overflow-hidden rounded-[28px] bg-[#31487B] shadow-[0_32px_80px_rgba(16,38,79,0.18)]"
          ...
          <div className="relative px-5 py-8 sm:px-8 sm:py-10 lg:px-[52px] lg:py-[52px]">
            <div className="relative mx-auto aspect-[987/159] w-full max-w-[987px]">
              <Image
                ...
                className="object-contain transition-transform duration-700 hover:scale-[1.025]"
                priority={false}
              />
            </div>
          </div>
