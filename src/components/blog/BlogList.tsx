...
export default function BlogList() {
  ...
  return (
    <main className="bg-[linear-gradient(180deg,#F4F9FF_0%,#FFFFFF_24%,#F6FAFF_100%)] text-[#11264B]">
      <section className="relative overflow-hidden bg-[#08142D] text-white">
        ...
        <div className="relative mx-auto flex min-h-[78svh] w-full max-w-[1568px] flex-col justify-center px-5 pb-14 pt-28 sm:px-8 sm:pt-32 lg:px-10 lg:pb-18 lg:pt-[118px] xl:px-16 xl:pt-[138px]">
          <div className="max-w-[860px]">
            ...
            <h1 className="mt-5 text-[2.8rem] font-bold leading-[0.96] tracking-[-0.05em] text-white sm:text-[3.8rem] lg:text-[5rem] xl:text-[5.6rem]">
              Insights, ideas, and real product thinking from the team.
            </h1>
            <p className="mt-5 max-w-[720px] text-[1rem] leading-[1.75] text-white/90 sm:text-[1.08rem] lg:text-[1.15rem]">
          ...
          <div className="mt-8 max-w-[760px] rounded-[30px] border border-white/12 bg-white/10 p-3 shadow-[0_28px_60px_rgba(0,0,0,0.18)] backdrop-blur-xl">
        ...
        <section className="px-5 py-14 sm:px-8 sm:py-16 lg:px-10 lg:py-20 xl:px-16">
          <div className="mx-auto flex w-full max-w-[1280px] flex-col gap-8">
            ...
            <Link
              ...
              className="group overflow-hidden rounded-[36px] border border-[#D7E7FB] bg-white shadow-[0_28px_60px_rgba(16,38,79,0.08)] transition duration-300 hover:-translate-y-1 hover:border-[#74CFFF] hover:shadow-[0_34px_70px_rgba(16,38,79,0.14)]"
            >
      ...
      <section className="px-5 pb-16 sm:px-8 sm:pb-20 lg:px-10 lg:pb-24 xl:px-16">
        <div className="mx-auto flex w-full max-w-[1280px] flex-col gap-8">
          <div className="flex flex-wrap items-end justify-between gap-4">
            ...
            <p className="text-[16px] text-[#5C6F8F]">
              {filteredBlogs.length} {filteredBlogs.length === 1 ? "article" : "articles"}
            </p>
          </div>

          {filteredBlogs.length === 0 ? (
            <div className="rounded-[34px] border border-[#D8E8FB] bg-white px-6 py-16 text-center shadow-[0_24px_60px_rgba(16,38,79,0.08)]">
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {gridBlogs.map((blog) => (
                <Link
                  key={blog.slug}
                  href={`/blog/${blog.slug}`}
                  className="group flex h-full flex-col overflow-hidden rounded-[30px] border border-[#D7E7FB] bg-white shadow-[0_20px_48px_rgba(16,38,79,0.06)] transition duration-300 hover:-translate-y-1 hover:border-[#74CFFF] hover:shadow-[0_28px_52px_rgba(23,45,86,0.14)]"
                >
