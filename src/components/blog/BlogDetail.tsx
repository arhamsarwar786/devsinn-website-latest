...
export default function BlogDetail({ blog }: { blog: Blog }) {
  ...
  return (
    <main className="bg-[linear-gradient(180deg,#F4F9FF_0%,#FFFFFF_22%,#F6FAFF_100%)] text-[#11264B]">
      <section className="relative overflow-hidden bg-[#07152F] px-5 pb-20 pt-[138px] text-white sm:px-8 sm:pb-24 sm:pt-[154px] lg:px-10 lg:pb-28 lg:pt-[168px] xl:px-16">
        ...
        <div className="relative mx-auto flex w-full max-w-[1280px] flex-col gap-8">
          ...
          <div className="flex flex-wrap items-center gap-3 text-[13px] font-medium uppercase tracking-[0.16em] text-white/76 sm:gap-5">
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(320px,0.8fr)] lg:items-end">
            <div className="max-w-[860px]">
              <h1 className="text-[40px] font-semibold leading-[0.98] tracking-[-0.05em] text-white sm:text-[54px] lg:text-[74px] xl:text-[88px]">
                {blog.title}
              </h1>
            </div>

            <div className="rounded-[28px] border border-white/12 bg-[#071A38]/66 p-6 backdrop-blur-md sm:p-8">
      ...
      <section className="-mt-10 px-5 pb-16 sm:px-8 sm:pb-20 lg:px-10 lg:pb-24 xl:px-16">
        <div className="mx-auto w-full max-w-[1280px]">
          <div className="overflow-hidden rounded-[34px] border border-[#D8E8FB] bg-white shadow-[0_34px_70px_rgba(16,38,79,0.12)]">
      ...
      <section className="px-5 pb-16 sm:px-8 sm:pb-20 lg:px-10 lg:pb-24 xl:px-16">
        <div className="mx-auto grid w-full max-w-[1280px] gap-12 lg:grid-cols-[minmax(0,1fr)_320px] lg:gap-10">
          <article className="rounded-[32px] border border-[#D8E8FB] bg-white px-6 py-8 shadow-[0_24px_60px_rgba(16,38,79,0.08)] sm:px-8 sm:py-10 lg:px-10 lg:py-12">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              {relatedBlogs.map((item) => (
                <Link
                  key={item.slug}
                  href={`/blog/${item.slug}`}
                  className="group overflow-hidden rounded-[30px] border border-[#D7E7FB] bg-[#F8FBFF] transition duration-300 hover:-translate-y-1 hover:border-[#74CFFF] hover:shadow-[0_28px_52px_rgba(23,45,86,0.14)]"
                >
                  ...
                  <div className="p-6">
                    ...
                    <span className="mt-5 inline-flex items-center gap-2 text-[15px] font-semibold text-[#17305F] transition-all duration-300 group-hover:gap-3">
                      Read Article
                      <ArrowRight size={16} />
                    </span>
                  </div>
